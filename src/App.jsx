...
//   const sumY2 = data.reduce((acc, curr) => acc + curr[yKey] * curr[yKey], 0);
...
//       name,
//       "Nota An Medie": (grouped[name].sum / grouped[name].count).toFixed(2),
//     }));
//   }, [data]);
...
//         clasa,
//         "Nota An Medie": (
//           grouped[clasa].notaSum / grouped[clasa].notaCount
//         ).toFixed(2),
//         "IMC Mediu": (grouped[clasa].imcSum / grouped[clasa].imcCount).toFixed(
//           2
//         ),
//       }))
//       .sort((a, b) => {
...
//   return (
//     <ChartCard title="Corelația IMC vs. Nota Anuală">
//       <ResponsiveContainer width="100%" height="100%">
...
//             dot={false}
//             activeDot={false}
//             isAnimationActive={false} // Disable animation for trendline
//             type="linear"
...
//           ? ((grouped[category].sport / grouped[category].total) * 100).toFixed(
//               2
//             )
//           : 0,
//     }));
...
//   const processedData = useMemo(() => {
//     const imcIntervals = {
//       "<18.5 (Subponderal)": { sum: 0, count: 0, minIMC: 0, maxIMC: 18.49 },
//       "18.5-24.9 (Normal)": { sum: 0, count: 0, minIMC: 18.5, maxIMC: 24.99 },
...
//         maxIMC: 29.99,
//       },
//       ">30 (Obez)": { sum: 0, count: 0, minIMC: 30.0, maxIMC: Infinity },
//     };
...
//           ? (imcIntervals[interval].sum / imcIntervals[interval].count).toFixed(
//               2
//             )
//           : 0,
//     }));
...
//         "Nota An Medie": (item.sum / item.count).toFixed(2),
//       }))
...
//     () => ["All", ...new Set(initialData.map((d) => d.clasa))].sort(),
//     []
//   );
//   const sexes = useMemo(
//     () =>
//       ["All", ...new Set(initialData.map((d) => d.sex))]
//         .map((s) => (s === "baiat" ? "Băiat" : s === "fata" ? "Fată" : "All"))
//         .sort(),
//     []
//   );
//   const imcCategories = useMemo(
//     () => ["All", ...new Set(initialData.map((d) => d.categorie_IMC))].sort(),
//     []
//   );
...
//     if (filters.clasa !== "All") {
//       newData = newData.filter((student) => student.clasa === filters.clasa);
//     }
//     if (filters.sex !== "All") {
//       const originalSex = filters.sex === "Băiat" ? "baiat" : "fata";
//       newData = newData.filter((student) => student.sex === originalSex);
//     }
//     if (filters.categorie_IMC !== "All") {
//       newData = newData.filter(
//         (student) => student.categorie_IMC === filters.categorie_IMC
//       );
//     }
//     if (filters.searchId) {
//       newData = newData.filter((student) =>
//         student.id.toLowerCase().includes(filters.searchId.toLowerCase())
//       );
//     }
...
//     return calculatePearsonCorrelation(initialData, "IMC", "nota_an");
//   }, []);
...
//               id="categorie_IMC"
//               name="categorie_IMC"
//               value={filters.categorie_IMC}
//               onChange={handleFilterChange}
//               className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md shadow-sm"
//             >
//               {imcCategories.map((option) => (
//                 <option key={option} value={option}>
//                   {option}
//                 </option>
//               ))}
...
//         <DistributionByIMCCategoryChart data={filteredData} />
//         <AverageNotaAnByIMCCategoryChart data={filteredData} />
//         <NotaAnBySexChart data={filteredData} />
//         <NotaAnAndIMCAveragePerClassChart data={filteredData} />
//         <NotaAnBySportPracticeChart data={filteredData} />
//         <IMCVsNotaAnCorrelationChart data={filteredData} />
//         <NotaAnByIMCSexCombinedChart data={filteredData} />
//         <MinMaxMeanNotaAnByIMCCategoryChart data={filteredData} />
//         <DistributionBySexChart data={filteredData} />
//         <DistributionByClassChart data={filteredData} />
//         <PercentageSportPerIMCCategoryChart data={filteredData} />
//         <NotaAnByGroupedIMCIntervalsChart data={filteredData} />
//         <NotaAnTrendsAcrossAgesAndBMICategoriesChart data={filteredData} />
//       </section>
